\newglossaryentry{IDMC-}{type=\acronymtype,sort={IDMC},name={IDMC},text={IDMC},description={Institut des sciences du Digital, Management et Cognition}}
\glsadd{IDMC-}
...
\glsadd{LORIA-}
\newglossaryentry{PAPUD-}{type=\acronymtype,sort={PAPUD},name={PAPUD},text={PAPUD},description={\foreign{Profiling and Analysis Platform Using Deep Learning} (plateforme de profilage et d'analyse utilisant l'apprentissage artificiel)}}
\glsadd{PAPUD-}
...
\glsadd{INRIA-}
\newglossaryentry{EUREKA-}{type=\acronymtype,sort={EUREKA},name={EUREKA},text={EUREKA},description={\foreign{European Research Co-ordination Agency} (agence de coordination de la recherche européenne)}}
\glsadd{EUREKA-}
...
%TAL
\newglossaryentry{XML-}{type=\acronymtype,sort={XML},name={XML},text={XML},description={\foreign{eXtensible Markup Language} (langage de balisage extensible)}}
\glsadd{XML-}
...
\glsadd{min-}
\newglossaryentry{KiB-}{type=\acronymtype,sort={Kio},name={Kio},text={Kio},description={kibioctet (kilooctet informatique, 1024 octets)}}
\glsadd{KiB-}
\newglossaryentry{MiB-}{type=\acronymtype,sort={Mio},name={Mio},text={Mio},description={mébioctet (mégaoctet informatique, 1024 Kio)}}
\glsadd{MiB-}
\newglossaryentry{GiB-}{type=\acronymtype,sort={Gio},name={Gio},text={Gio},description={gibioctet (gigaoctet informatique, 1024 Mio)}}
\glsadd{GiB-}
