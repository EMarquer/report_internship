...
\newglossaryentry{rnn-}{type=\acronymtype, name={RNN}, text={RNN},
	description={réseau de neurones récurrents (\foreign{Recurrent Neural Network} en anglais)}}
...
\newglossaryentry{lstm-}{type=\acronymtype, name={LSTM}, text={LSTM},
	description={réseau récurent à mémoire à court et long terme (\foreign{Long Short Term Memory} en anglais)}}

\newglossaryentry{gmsnn-}{
	type=\acronymtype,
	name={{GMSNN}},
	text={{GMSNN}},
	description={réseau de neurones récurrents multi-échelles croissant (\foreign{Growing Multi-Scale Recurrent Neural Network} en anglais)}}

\newglossaryentry{gmsnn}{
	name={{Réseau de neurones récurrents multi-échelles croissant}},
	text={{GMSNN}},
...
\newglossaryentry{gpu-}{
	...
	name={GPU},
	text={GPU},
	description={processeur graphique (\foreign{Graphical Processing Unit} en anglais, GPU)}}
