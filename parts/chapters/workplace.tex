...
Il est dirigé par quatre instances\footfullcite{organisation_loria}:
\begin{itemize}
...
Un organigramme complet du \gls{loria} est disponible sur {le site du laboratoire \footfullcite{org_loria}}
...
Des informations plus détaillées sur le \gls{loria} sont disponible sur {le site du laboratoire \footfullcite{about_loria}}.
Par ailleurs, la liste complète des membres de l'équipe, ainsi que des informations plus détaillées sont disponible sur {le site de \gls{synalp} (en anglais) \footfullcite{about_synalp}}.
...
\og\gls{eureka} est une initiative européenne, intergouvernementale, destinée à renforcer la compétitivité de l’industrie européenne.\fg{} D'après Wikipedia \footfullcite{wiki_eureka}.
...
\begin{table}[h]{
	...
	\caption[Informations générales sur le \gls{project_papud}, d'après le site de \gls{itea3}]{Informations générales sur le \gls{project_papud}, d'après le site de \gls{itea3} \footfullcite{about_papud} \label{tab:about_papud}}
\end{table}
...
D'après {le site d'\gls{atos}\footfullcite{bull_produits}}, les activités principales de la filiale \gls{bull} sont:
\begin{itemize}
...
\subsection*{Pour en savoir plus}
Des informations plus détaillées sur le \gls{project_papud} sont disponible sur la page web du projet \footfullcite{about_papud}.
Les %todo
