\subsection{Entraînement par exemples simultanés ; \Glsentrytext{batch}} \label{subsec:optibatch}
...
L'algorithme basé sur ce principe appelé \foreign{mini-batch}\autocite{batch}.
