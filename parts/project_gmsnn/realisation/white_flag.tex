...
Celle-ci a permis de définir les objectifs du \glsfirst{project_papud}\footnote{L'expression \og cas d'utilisation\fg{} est utilisé en gestion de projet pour désigner une partie d'un projet. Elle désigne ici la partie du projet PAPUD destinée à répondre aux besoins de l'entreprise Bull.} (voir \autoref{ch:project_papud}, \autopageref{ch:project_papud}), qui ont été influencés par nos conclusions.
