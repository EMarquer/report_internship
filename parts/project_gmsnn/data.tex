...
Quelques fragments de XML\footnote{XML (\foreign{eXtensible Markup Language} en anglais), \og est un langage informatique qui sert à enregistrer des données textuelles. [...] Ce langage , [...] similaire à l'HTML de par son système de balisage, permet de faciliter l'échange d'informations sur l'internet \fg{}, d'après le glossaire sur \emph{infowebmaster} \autocite{xml}. Il s'agit du format sous lequel sont stockés les articles Wikipédia.}
...
Le \autoref{enwik8_ex} (\autopageref{enwik8_ex}) est un extrait des données brutes avant le découpage en caractères. Il correspond à l'article Wikipédia sur l'anarchisme.
