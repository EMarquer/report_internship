...
La structure générale du \gls{loria} en départements et, plus en détail, du Département 4 est représentée sur l'organigramme de la figure \ref{fig:dep_org} (\autopageref{fig:dep_org}). % TODO remove pageref
