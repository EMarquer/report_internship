...
\begin{itemize}
	...
	\item pour mesurer la consommation de ressources, on évalue l'espace mémoire occupé (en \gls{MiB-} ou \gls{GiB-}), la puissance de calcul utilisée (pourcentage de la puissance disponible), etc.
\end{itemize}
\vspace{1em}
