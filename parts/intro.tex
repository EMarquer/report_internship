...
D'autre part, nous somme à l'ère du \og\foreign{Big Data}\fg{}, et les quantités de \glspl{data} produites de nos jours est bien au delà de ce que nous pouvons gérer sans outils spécialisés.
...
Cela implique des problématiques relativement classiques en développement de \gls{nn}~: le choix de l'architecture du réseau, de l'algorithme d'entraînement, mais aussi des questions plus pragmatique d'optimisation lié au volume de \glspl{data}.% TODO applatir et dégonfler ce paragraphe 
...
% Version résumée
L'objectif initial du stage était d'explorer une idée d'architecture de \gls{nn} innovante, imaginée par notre maître de stage Mr.~Cerisara. Il s'agit du \glsunset{project_gmsnn}\gls{project_gmsnn}.
