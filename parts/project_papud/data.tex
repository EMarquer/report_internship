...
Entre autre, la date et le \foreign{timestamp} (nombre correspondant à la date) ont été remplacées par le date de début du stage et le \foreign{timestamp} correspondant, et l'utilisateur a été renommé \og OOOOOO \fg{}.
