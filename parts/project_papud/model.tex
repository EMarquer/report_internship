...
Pour chacun d'entre eux, comme dans le modèle \gls{gmsnn}, est transformé en un \gls{tensor} par un module d' \gls{embedding}\footnote{Voir \autoref{def:embeding}, \autopageref{def:embeding}.}.
