...
Pour ce qui est du modèle simple, il à été décidé de ne pas utiliser de \gls{rnn}, bien trop lent pour la quantité de données à traiter. À la place, un \gls{nn} basique sera utilisé.
