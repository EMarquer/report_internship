...
%TODO compléter avec dépendances ....

Le plan général des opérations est divisé en 2 parties~: %TODO reformuler
\begin{enumerate}
...
Pour ce qui est du modèle simple, il à été décidé de ne pas utiliser de \gls{rnn}, bien trop lent pour la quantité de données à traiter. À la place, un \gls{nn} basique, intégralement connecté (comme celui présenté dans la \autoref{fig:nn}), sera utilisé. % TODO transférer integralement ... au chapitre modèle
...
\begin{figure}[ht]
	\centering
	\input{plots/timeline_papud}\caption{Répartition du travail}\label{fig:papud_time}
\end{figure}
...
% TODO Python, PyTorch (deja entrainé, portabilité des modules deja codés)