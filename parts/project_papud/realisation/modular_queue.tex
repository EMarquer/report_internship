...
C'est d'ailleurs lors de l'implémentation de ces modules que le \gls{preprocessing} mentionnée \autoref{sec:spike} (\autopageref{sec:spike}) et \autoref{hex} (\autopageref{hex}) a été intégré.
