...
\newcommand\TimeLine[1]{%
	...
	\foreach \Longitud/\Color/\Texto [count=\ti] in {#1}
	{
		...
		\node (lower\the\numexpr\ti-1\relax) at  ($(part\ti.west) + (0,2em)$) {};
		\node[text width=\the\numexpr\Longitud*2\relax em,text centered]
...
\AddText{yellow2!50!}{Corpus, analyse \\ et mod\`{e}le basiques}{1}{M}
\AddText{yellow3!50!}{Premiers r\'{e}sultats, \\ corpus gros volume}{2}{m}
\AddText{green!15!}{Nouveau score, \\ analyse du pic \\ de performance}{3}{M}
\AddText{blue!15!}{Recherche du taux \\ d'apprentissage, \\ corpus multi-queues}{4}{m}
\AddText{purple!15!}{Documentation}{5}{M}
